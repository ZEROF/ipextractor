...
### Removed
- ThreatFox feed was removed

### Fixed
- Removed unused html tag from code

### Changed
- List (table) with feeds updated

## [1.1.8] 11-04-2026

### Added
- Add new infrastructure to run Fortigate Honeypot
...
### Added
- New document for integration with PfSense is created after original source was removed

### Removed
- Old PfSense instruction URL
...
### Removed
- Python offical image was replaced with debian trixie to fix few security flows

### Fixed
- Job permission security (Github security alerts)

### Changed
- Update python version to 3.14.2 
...
### Fixed
 - Hunters brain (RFC1918 reserved addresses)
